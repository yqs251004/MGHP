...
import argparse
from reproduce.train.trainer import ContrastiveTrainer
...
parser.add_argument("--alpha", type=float, default=1, help="Alpha weight for harmful loss")
parser.add_argument("--beta", type=float, default=0.001, help="Beta weight for noise loss")
parser.add_argument("--steps", type=int, default=None, help="Number of training steps")
args = parser.parse_args()

wandb.init(project="repnoise", name="contrastive_beta_"+str(args.beta))
