...
parser.add_argument("--name", type=str, default="lisa_fsdp", help="Wandb run name")
args = parser.parse_args()

init_distributed()

if is_main_process():
    wandb.init(project="lisa_fsdp", name=args.name)
...
log_training_start("train_lisa_fsdp.py", args, device)
