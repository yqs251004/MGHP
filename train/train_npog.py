...
import argparse
from reproduce.train.trainer import NPOGTrainer
...
parser.add_argument("--rho", type=float, default=0.05, help="Rho weight for perturbation")
parser.add_argument("--beta", type=float, default=1, help="Beta perturbation for training")
parser.add_argument("--steps", type=int, default=None, help="Number of training steps")
parser.add_argument("--name", type=str, default="npog", help="Wandb run name")
args = parser.parse_args()

wandb.init(project="npog", name=args.name)
