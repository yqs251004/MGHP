...
import argparse
from reproduce.train.trainer import BoosterDualTrainer
...
parser.add_argument("--lam", type=float, default=0.01, help="Lambda weight for dual loss")
parser.add_argument("--steps", type=int, default=None, help="Number of training steps")
args = parser.parse_args()

wandb.init(project="booster", name="booster_dual_safer_alpha_"+str(args.alpha))
